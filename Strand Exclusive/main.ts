...
namespace StrandExklusive {
    ...
    function handleLoad(): void {
        ...
        let allStrandItems: BeachElement[] = [];
       ...
       allStrandItems.push(new Boden(new Vector(0, 200)));
        ...
        allStrandItems.push(new Wolke(new Vector(600, 125), new Vector(150, 75), new Vector(1, 0)));
        allStrandItems.push(new Wolke(new Vector(200, 145), new Vector(120, 65), new Vector(0.5, 0)));
        ...
        allStrandItems.push(new Person(new Vector(300, 410), "shirt", "#8800FF"));
        allStrandItems.push(new Person(new Vector(410, 420), "skirt", "#C4FAF8"));
        ...
        allStrandItems.push(new Moewe(new Vector(700, 60), new Vector(1.2, 1.3), new Vector(1, -0.5)));
        allStrandItems.push(new Moewe(new Vector(100, 75), new Vector(1.3, 1.3), new Vector(4, 3)));
        allStrandItems.push(new Moewe(new Vector(490, 550), new Vector(1.5, 1.5), new Vector(9, 2)));
