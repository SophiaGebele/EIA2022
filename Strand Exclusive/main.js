...
(function (StrandExklusive) {
    ...
    function handleLoad() {
        ...
        allStrandItems.push(new Sonne(new StrandExklusive.Vector(400, 195)));
        allStrandItems.push(new Boden(new StrandExklusive.Vector(0, 200)));
        //allBeachElements.push(new Beach(new Vector(0, 300)));
        allStrandItems.push(new Wolke(new StrandExklusive.Vector(600, 125), new StrandExklusive.Vector(150, 75), new StrandExklusive.Vector(1, 0)));
        allStrandItems.push(new Wolke(new StrandExklusive.Vector(200, 145), new StrandExklusive.Vector(120, 65), new StrandExklusive.Vector(0.5, 0)));
        ...
        allStrandItems.push(new Person(new StrandExklusive.Vector(300, 410), "shirt", "#8800FF"));
        allStrandItems.push(new Person(new StrandExklusive.Vector(410, 420), "skirt", "#C4FAF8"));
        ...
        allStrandItems.push(new Moewe(new StrandExklusive.Vector(700, 60), new StrandExklusive.Vector(1.2, 1.3), new StrandExklusive.Vector(1, -0.5)));
        allStrandItems.push(new Moewe(new StrandExklusive.Vector(100, 75), new StrandExklusive.Vector(1.3, 1.3), new StrandExklusive.Vector(4, 3)));
        allStrandItems.push(new Moewe(new StrandExklusive.Vector(490, 550), new StrandExklusive.Vector(1.5, 1.5), new StrandExklusive.Vector(9, 2)));
