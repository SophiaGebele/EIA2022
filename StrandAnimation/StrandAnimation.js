...
(function (AnimationStrand) {
    ...
    //Variablen
    AnimationStrand.crc2 = document.querySelector("canvas")?.getContext("2d");
    //start
    function start(_event) {
        ...
        let wolke = new AnimationStrand.Wolke(1);
        console.log(wolke);
        wolke.draw();
    } //start Ende
})(AnimationStrand || (AnimationStrand = {})); //NamespaceEnde
//# sourceMappingURL=StrandAnimation.js.map